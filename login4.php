                        ...
                        <div class="col-md-6">
                            <form id="registerForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="registerGender" name="registerGender">
                        ...
                        <div class="col-md-6">
                            <form id="registerForm">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="registerBirthday" name="registerBirthday">
                                </div>
                                <div class="form-group">
                                    <label for="registerCEP">CEP:</label>
                                    <input type="text" class="form-control" id="registerCEP" name="registerCEP">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="registerNeighborhood" name="registerNeighborhood">
                                </div>
                                <div class="form-group">
...
document.getElementById('toggleSignup').addEventListener('click', function(event) {
    ...
    // Oculta a seção de login e mostra a seção de cadastro
...
document.getElementById('toggleLogin').addEventListener('click', function(event) {
    ...
    // Oculta a seção de cadastro e mostra a seção de login
